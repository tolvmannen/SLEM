...
def VPC(params):
    ...
    Subnet_As_ID = Subnet_As_ID.split("'")[1].strip("\\r\\n")
    ...
    VPC_As_ID = VPC_As_ID.split("'")[1].strip("\\r\\n")
    ...
    while Pu_CB_state != "disassociated" and LAN_CB_state !="disassociated" and DMZ_CB_state != "disassociated" and VPC_CB_state != "disassociated":
        ...
        Pu_CB_state = Pu_CB_state.split("'")[1].strip("\\r\\n")
        ...
        LAN_CB_state = LAN_CB_state.split("'")[1].strip("\\r\\n")
        ...
        DMZ_CB_state = DMZ_CB_state.split("'")[1].strip("\\r\\n")
        ...
        VPC_CB_state = VPC_CB_state.split("'")[1].strip("\\r\\n")
        time.sleep(5)
